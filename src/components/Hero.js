    ...
    return (
      <HeroWrapper>
        ...
        <HeroIntro>
          ...
          <p>This is my personal website, portfolio, and blog. I also list the technologies I use and want to learn below. Apologies for the lack of design on the site, this is due to time constraints but mainly because whilst I want to learn more about good design, I will always be a developer rather than a designer.</p>
        </HeroIntro>
        <HeroLists />
      </HeroWrapper>
    )
